                    ...
                    <div class="dd" id="nestable">
                        <ol class="dd-list">
                            <li class="dd-item" data-id="1">
                                <div class="dd-handle">班级</div>
                            </li>
                            <li class="dd-item" data-id="2">
                                <div class="dd-handle">一班</div>
                                <ol class="dd-list">
                                    <li class="dd-item" data-id="3">
                                        <div class="dd-handle">一组</div>
                                    </li>
                                    <li class="dd-item" data-id="4">
                                        <div class="dd-handle">二组</div>
                                    </li>
                                </ol>
                            </li>
                            <li class="dd-item" data-id="5">
                                <div class="dd-handle">二班</div>
                                <ol class="dd-list">
                            ...
                            <li class="dd-item" data-id="8">
                                <div class="dd-handle">3班</div>
                            </li>
                            <li class="dd-item" data-id="9">
                                <div class="dd-handle">4班</div>
                            </li>
                        </ol>
                    </div>
                </div>
...
<div class="wrapper wrapper-content  animated fadeInRight" style="float: right">
    <div class="row">
        <div class="col-sm-4">
            <div class="ibox">
                <div class="ibox-content">
...
<div class="mail-body text-right tooltip-demo" style="margin-left: 500px;float: right" >
