...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="/page/jiaoan/jiaoxueplanboss">教学计划完成状况（boss）</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/page/jiaoan/jiaoxueplanstu">教学计划完成状况（stu）</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/page/jiaoan/stulookplan">作业下载</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/page/jiaoan/jiaoxueplan?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
